...
button1:{"type":"button","size":[76,20],"pos":[165,200],"script":"card4.0","text":"Take Candy"}
...
<input id="source" type="file" style="display:none" accept=".html,.deck">
<canvas id="render" style="display:none" width="512" height="342"></canvas>
<canvas id="lrender" style="display:none" width="45" height="344"></canvas>
<canvas id="rrender" style="display:none" width="45" height="344"></canvas>
<canvas width="0" height="0" id="ltools"></canvas>
<canvas id="display" width="1536" height="1026" style="cursor: default;"></canvas>
